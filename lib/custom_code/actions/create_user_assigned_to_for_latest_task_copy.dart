...
Future<void> createUserAssignedToForLatestTaskCopy() async {
    ...
    if (assignedToUserId != null) {
      ...
      if (userNameUserId != null) {
        if (assignedToUserId == userNameUserId) {
          ...
          // If assigned_to and user_name are different, create separate records for each with different role_ids
          recordsToInsert.add(
              {'user_id': assignedToUserId, 'task_id': taskId, 'role_id': 3});
          recordsToInsert.add(
