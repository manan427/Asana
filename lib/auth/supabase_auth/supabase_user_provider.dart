...
class CloneasanaSupabaseUser extends BaseAuthUser {
  CloneasanaSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> cloneasanaSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = CloneasanaSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
