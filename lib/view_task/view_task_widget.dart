...
class ViewTaskWidget extends StatefulWidget {
  ...
  @override
  State<ViewTaskWidget> createState() => _ViewTaskWidgetState();
}
...
class _ViewTaskWidgetState extends State<ViewTaskWidget> {
  ...
  void initState() {
    ...
    _model.taskTextController ??=
        TextEditingController(text: widget.data?.taskname);
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            Visibility(
              visible: widget.data?.roleName == 'Assignor',
              child: Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(0.0, 8.0, 12.0, 8.0),
                child: FlutterFlowIconButton(
